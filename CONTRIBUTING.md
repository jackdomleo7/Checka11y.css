...
2. Update the [README.md Features section](./README.md#Features), the [references.md](./references.md) and the [test/index.html](./test/index.html) with details of changes to the stylesheet and new a11y checks.
