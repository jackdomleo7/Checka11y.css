...
2. Update the [references.md section](./references.md) and the [test/index.html](./test/index.html) with details of changes to the stylesheet and new a11y checks.
